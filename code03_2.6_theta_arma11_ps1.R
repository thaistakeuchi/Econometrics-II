...
results <- foreach(
  ...
  for (m in 1:M) {
    ...
    resultsT$reject[m] <- as.numeric(
      abs((arma11$coef[2] - theta) / sqrt(arma11$var.coef[2,2])) >= qnorm(0.975)
    )
...
if (g == 1) {
  ggsave("figures/figure_convergence-prob-normal_theta_arma11.pdf", width = 11, height = 8.5)
} else {
  ggsave("figures/figure_convergence-prob-exp_theta_arma11.pdf", width = 11, height = 8.5)
}
...
## Save figure: The figure's file name depends on the value of g
if (g == 1) {
  ggsave("figures/figure_convergence-distr-normal_theta_arma11.pdf", width = 11, height = 8.5)
} else {
  ggsave("figures/figure_convergence-distr-exp_theta_arma11.pdf", width = 11, height = 8.5)
}
...
if (g == 1) {
  anim_save("frames/gif_convergence-dist-normal_theta_arma11.gif")
} else {
  anim_save("frames/gif_convergence-dist-exp_theta_arma11.gif")
}
...
# Save figure: The figure's file name depends on the value of g
if (g == 1) {
  ggsave("figures/figure_rejection-rate-normal_theta_arma11.pdf", width = 11, height = 8.5)
} else {
  ggsave("figures/figure_rejection-rate-exp_theta_arma11.pdf", width = 11, height = 8.5)
}
