...
if (g == 1) {
  ggsave("figures/figure_convergence-prob-normal_phi_ar1.pdf", width = 11, height = 8.5)
} else {
  ggsave("figures/figure_convergence-prob-exp_phi_ar1.pdf", width = 11, height = 8.5)
}
...
## Save figure: The figure's file name depends on the value of g
if (g == 1) {
  ggsave("figures/figure_convergence-distr-normal_phi_ar1.pdf", width = 11, height = 8.5)
} else {
  ggsave("figures/figure_convergence-distr-exp_phi_ar1.pdf", width = 11, height = 8.5)
}
...
if (g == 1) {
  anim_save("frames/gif_convergence-dist-normal_phi_ar1.gif")
} else {
  anim_save("frames/gif_convergence-dist-exp_phi_ar1.gif")
}
...
# Save figure: The figure's file name depends on the value of g
if (g == 1) {
  ggsave("figures/figure_rejection-rate-normal_phi_ar1.pdf", width = 11, height = 8.5)
} else {
  ggsave("figures/figure_rejection-rate-exp_phi_ar1.pdf", width = 11, height = 8.5)
}
